...
const Modal: FC<ModalProps> = ({
	...
	return (
		<>
			...
			focus:outline-none bg-neutral-800/60 backdrop-blur-sm">
				<div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 
				my-6 mx-auto h-full lg:h-auto md:h-auto">
					...
					${showModal ? 'opacity-100' : 'opacity-0'}`}>
						...
						bg-white/90 backdrop-blur-sm outline-none focus:outline-none">

							{/* HEADER */}
							<div className="flex items-center p-6 rounded-t 
							justify-center bg-white/40 relative border-b-[.1rem] border-[#ccc]">
								<button 
									onClick={onClose}
									className=' p-1 border-0 absolute right-9'>
									<IoMdClose 
